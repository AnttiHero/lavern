...
// StaffingView was split into StrategyView + TeamView; this suite covers the team page.
...
describe('TeamView (formerly StaffingView)', () => {
  ...
  it('renders back button', () => {
    ...
    expect(screen.getByText(/Strategy/)).toBeInTheDocument(); // back button reads '← Strategy'
  });
