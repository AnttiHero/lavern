...
const DEMO_WORKFLOWS: WorkflowSummary[] = [
  ...
  { id: 'defence-disclosure', name: 'Defence Disclosure', description: 'Ontario/Canada criminal disclosure, fraud, OSC crossover, motions/factums, and forensic accounting support', stepCount: 11, steps: ['intake', 'document_inventory', 'procedural_frame', 'disclosure_review', 'element_proof_matrix', 'forensic_accounting_review', 'contradiction_gap_analysis', 'crown_osc_red_team', 'counsel_ready_synthesis', 'final_gate', 'delivered'], requiredAgents: ['criminal-defence-counsel', 'disclosure-analyst', 'forensic-accounting-analyst', 'motion-factum-analyst', 'red-team', 'evaluator'], gateCount: 1, hasGates: true, gateSteps: ['final_gate'] },
