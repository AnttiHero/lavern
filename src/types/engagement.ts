...
export const INTENSITY_PROFILES: Record<IntensityLevel, IntensityProfile> = {
  ...
  thorough: {
    level: 'thorough',
    label: 'Thorough',
    description: 'Large team with standard gates. For complex matters requiring high assurance.',
    effort: 'high',
  ...
  maximal: {
    level: 'maximal',
    label: 'Maximal',
    description: 'Full firm engagement. Every gate, every specialist. Maximum quality and oversight.',
    effort: 'max',
    budgetMultiplier: 4.0,
    suggestedTeamSize: 25,
    gateFrequency: 'all',
 ...
 * maximal → max    (white-shoe effort — no token limits, Opus 4.6 only)
 */
