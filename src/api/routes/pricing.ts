  ...
  return [
    {
      ...
      inputPerMillion: PRICING['claude-opus-4-6'].input,
      outputPerMillion: PRICING['claude-opus-4-6'].output,
      cacheReadPerMillion: PRICING['claude-opus-4-6'].cacheRead,
      cacheWritePerMillion: PRICING['claude-opus-4-6'].cacheWrite,
    },
    {
      model: 'claude-sonnet-4-5-20250929',
      tier: 'Associate / Specialist',
      ...PRICING['claude-sonnet-4-5-20250929'],
      inputPerMillion: PRICING['claude-sonnet-4-5-20250929'].input,
      outputPerMillion: PRICING['claude-sonnet-4-5-20250929'].output,
      cacheReadPerMillion: PRICING['claude-sonnet-4-5-20250929'].cacheRead,
      cacheWritePerMillion: PRICING['claude-sonnet-4-5-20250929'].cacheWrite,
    },
    {
