...
function buildTokenRates(): TokenRate[] {
  return [
    ...
    },
    {
      ...
      ...PRICING['claude-sonnet-4-7'],
      inputPerMillion: PRICING['claude-sonnet-4-7'].input,
      outputPerMillion: PRICING['claude-sonnet-4-7'].output,
      cacheReadPerMillion: PRICING['claude-sonnet-4-7'].cacheRead,
      cacheWritePerMillion: PRICING['claude-sonnet-4-7'].cacheWrite,
    },
    {
