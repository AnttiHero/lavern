  ...
  return [
    {
      ...
      inputPerMillion: PRICING['claude-opus-5'].input,
      outputPerMillion: PRICING['claude-opus-5'].output,
      cacheReadPerMillion: PRICING['claude-opus-5'].cacheRead,
      cacheWritePerMillion: PRICING['claude-opus-5'].cacheWrite,
    },
    {
      model: 'claude-sonnet-5',
      tier: 'Associate / Specialist',
      ...PRICING['claude-sonnet-5'],
      inputPerMillion: PRICING['claude-sonnet-5'].input,
      outputPerMillion: PRICING['claude-sonnet-5'].output,
      cacheReadPerMillion: PRICING['claude-sonnet-5'].cacheRead,
      cacheWritePerMillion: PRICING['claude-sonnet-5'].cacheWrite,
    },
    {
